...
public class DlgPermintaanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-12-2025" }));
    ...
    private void BtnBridgingSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBridgingSEPActionPerformed
        ...
        if(tbObat.getSelectedRow()>-1){
            if(tbObat.getValueAt(tbObat.getSelectedRow(),0).toString().equals("")){
                ...
                dlgki.isCek();
                dlgki.setNoRm(NoRw.getText(),Valid.SetTgl2(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString()),"1. Ranap","","");
